...
function Read_Lao_Jungle() {
    ...
    <>
        ...
        <Modal.Body className='read-body'>
            ...
            I had actually never seen a coffee plant before, so getting a close look at them in addition to the piles of drying beans was very interesting for me. In the village, 
            ...
            more lush and healthy looking. This was also my first time in a tropical environment before so everything was extra exotic and fascinating. We hiked for some time before we 
            ...
            grind against the wires  for slowing down. I believe this was also my first time ziplining so as you can see, it was a trip of many firsts. I guess I can only describe it 
            ...
            The rest of the day consisted largely of zipping from one tree platform to the next as we worked our way down the valley. The culminating event was definitely going directly 
            over Tiger falls, again just utterly surreal flying over and looking down at this monstrous waterfall gushing off the edge of the plateau and into this hidden jungle valley we'd been led into. 
            ...
            up and out of the valley and back the way we came. This involved some rock climbing which also treated us to more spectacular views of the valley and waterfall. I didn't book that trip, 
