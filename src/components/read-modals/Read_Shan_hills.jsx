...
function Read_Shan_Hills() {
    ...
    <>
        ...
        <Modal.Body className='read-body'>
            ...
            We set out in the morning from Kalaw in the back of a truck and were then dropped off by the edge of a forest where our real trek began. For myself, as an American from the developed world, it was really like 
            stepping into another world. The highlands are inhabited by a patchwork of ethnic groups who even living within kilometers of each other, less at times, speak their own languages and if I remember correctly, 
            ...
            have largely lost. Anyway, those thoughts aside, the countryside was lush and beautiful and it was fascinating to see such a different way of life from my own. Though quite quite undeveloped, the highlands are not wholly so, 
