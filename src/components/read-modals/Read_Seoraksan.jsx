...
function Read_Seoraksan() {
    ...
    <>
        ...
        <Modal.Body className='read-body'>
            ...
            and the East Sea beyond. Seoraksan is also home to several Budhist temples and a giant Buddha statue as well. The park is beautiful in all four seasons, though Fall and Spring are by far the most pleasant. 
