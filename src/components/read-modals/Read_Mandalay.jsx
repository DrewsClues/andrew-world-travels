...
function Read_Mandalay() {
    ...
    <>
        ...
        they had a type of long skirt on called "Longyi", women too, though of more colorful or floral patterns. While buying my bus ticket at the airport, I noticed that 
        ...
        didn't understand. When I reached my hostel, "Ostello Bello, Mandalay" (Presumably closed now), the woman also had the same golden paint on her face and explained 
        to me that it's a paste called "Thanaka", made from rubbing tree bark against a wet stone and is used for aesthetic, skincare, and sunscreen. I was also told that it was 
        happy hour and I could order two mojitos for only $5 as well as dinner. I headed up to the rooftop bar just in time for sunset where I received my drinks, dinner, and also 
         a traditional Myanmar banana leaf cigar called "Cheroot", of which they had giant free baskets. The next morning, I had a few hours free before a bus would take me to 
         ...
         approached me and wanted to sell me a tour of the city, I told him that I didn't have time etc. and of my intentions to find breakfast, he told me that he knew a much better spot 
         ...
         restaurant down the street. The place was crowded with local people, he then ordered me a really great noodle soup, milk tea, and a bowl of cigarettes, all brought to us by our 
