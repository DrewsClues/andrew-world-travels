...
function Read_Fukuoka() {
    ...
    <>
        ...
        <Modal.Body className='read-body'>
            Fukuoka (福岡市), is a city of around 5 million people located on the west coast of Japan's southern island of Kyushu. I traveled there by myself in late December of 2022 after having to 
            cancel my trip to visit family in the USA due to a blizzard. Due to the sudden nature of my trip, I had done little to no research, or made any plans. However, everything worked out 
            and I had a great time nonetheless. I stayed in a dorm room at a hostel called <a href='https://maps.app.goo.gl/BgsXCasCyATtbpoL9' target='blank'>HafH Fukuoka THE LIFE</a> located just a few
            ...
            <a href='https://maps.app.goo.gl/JnJDb43Z4jqU9i8j9' target='blank'> Fukuoka Castle ruins</a>. After my not quite birds' eye view of the city, I made it to<a href='https://maps.app.goo.gl/JnJDb43Z4jqU9i8j9' target='blank'> Ohori Park</a>, just as the sun was starting to set. 
