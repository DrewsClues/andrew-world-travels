...
function Read_taxis() {
    ...
    return (
    <>
        <Nav.Link href="#home" onClick={() => setLgShow(true)} >Taxis</Nav.Link>
        <Modal
        size="lg"
        show={lgShow}
        ...
        <Modal.Body className='read-body'>
            ...
            a waste. However, somewhere like Bangkok it can be far more reasonable to take a cab. Usually the first place this will come into play is at the airport 
            ...
            have an integrated train or subway network, others have city bus stops, and some have shared vans that will drop every passenger off at their respective 
            accomodation. Also, many countries have services like GRAB and UBER which can be a great option too. 
            However, we're here to talk about taxis, so let's assume you've chosen that. In many countries, airports are a fantastic place to get SCAMMED, 
            big time. Particularly in poorer countries expect to be greeted immediately by soliciting cab drivers, or absolutely mobbed as happened to me in Kathmandu, Nepal. 
            ...
            to use it, and just stubbornly repeat their rate. Luckily, most airports have information desks in the arrival hall, go to one, show them where you want to go 
